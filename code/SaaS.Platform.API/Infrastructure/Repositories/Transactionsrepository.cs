...
namespace SaaS.Platform.API.Infrastructure.Repositories
{
    ...
    public class TransactionsRepository : GenericRepository<Transactions>, ITransactionsRepository
    {
        ...
        public async Task<IEnumerable<Transactions>> GetByTenantIdAsync(Guid tenantId)
        {
            return await _dbSet
        ...
        public async Task<IEnumerable<Transactions>> GetActiveTransactionsAsync(Guid tenantId)
        {
            return await _dbSet
                .Where(c => c.TenantId == tenantId )
                .ToListAsync();
        ...
        public async Task<IEnumerable<Transactions>> SearchTransactionsAsync(Guid tenantId, string searchTerm)
        {
        ...
        public async Task<(IEnumerable<Transactions> Items, int TotalCount)> GetTransactionsPagedAsync(
            Guid tenantId,
