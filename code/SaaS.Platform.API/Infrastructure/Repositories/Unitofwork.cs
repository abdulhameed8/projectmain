...
namespace SaaS.Platform.API.Infrastructure.UnitOfWork
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IAccountTypesRepository AccountTypes
        {
            get
            {
                _accountTypesRepository ??= new AccountTypesRepository(_context);
        ...
        public IChargesRepository Charges
        {
            get
            {
                _chargesRepository ??= new ChargesRepository(_context);
                return _chargesRepository;
            }
        }

        public ITransactionTypesRepository TransactionTypes
        {
            get
            {
        ...
        public ILoanTypesRepository LoanTypes
        {
            get
            {
                _loanTypesRepository ??= new LoanTypesRepository(_context);
                return _loanTypesRepository;
            }
        }

        public ILoanRepaymentsRepository LoanRepayments
        {
            get
            {
                _loanRepaymentsRepository ??= new LoanRepaymentsRepository(_context);
                return _loanRepaymentsRepository;
            }
        }
        ...
        public IWorkflowInstancesRepository WorkflowInstances
        {
            get
            {
                _workflowInstancesRepository ??= new WorkflowInstancesRepository(_context);
                return _workflowInstancesRepository;
            }
        }
        ...
        public IWorkflowTaskRepository WorkflowTasks
        {
            get
            {
                _workflowTaskRepository ??= new WorkflowTaskRepository(_context);
                return _workflowTaskRepository;
            }
        }
