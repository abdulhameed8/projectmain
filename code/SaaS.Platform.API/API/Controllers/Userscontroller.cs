...
namespace SaaS.Platform.API.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<Userdto>>> CreateUser([FromBody] CreateUserdto createUserdto)
        {
            try
            {
                _logger.LogInformation("Creating new user with  user {TenantId}",
            ...
            [FromBody] UpdateUserdto updateUserDto)
        {
            try
            {
                ...
                return Ok(new ApiResponse<Userdto>(userDto, "Tenant updated successfully"));
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<ApiResponse<object>>> DeleteUser(Guid id)
        {
            ...
            {
                _logger.LogError(ex, "Error occurred while deleting user {TenantId}", id);
                throw;
            }
        }
        ...
        public async Task<ActionResult<ApiResponse<List<Userdto>>>> GetActiveUsers([FromQuery] Guid tenantId)
        {
            ...
            {
                _logger.LogError(ex, "Error occurred while fetching active users for user {TenantId}", tenantId);
                throw;
            }
        }
    }
